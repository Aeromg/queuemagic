...
bus_interact: Взаимодействует с данными модулей через шину конвейера
	[arg_1] - object устанавливаемое на шине значение с произвольным индексом arg_1
	...
	[arg_N] - object устанавливаемое на шине значение с произвольным индексом arg_N
